        ...
        if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
            ...
            if (!s.empty()) {
                ...
                if (event == "telemetry") {
                    ...
                    //degree radian conversion and sign flip again since simulator uses opposite angle (Thanks slack)
                    ...
                    // we'll generate some new waypoints with small distance for smoother line
